                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                                        <div class="ec-slide-content slider-animation">
                                            ...
                                            @auth
                                                <button type="button" name="AddToCart" value="{{ $key->id }}" class="btn btn-lg btn-secondary">Sepete Ekle</button>
                                            @else
                                                <button type="button" name="BtnAddToCart" class="btn btn-lg btn-secondary">Sepete Ekle</button>
                                            @endauth
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="ec-product-csc">
                            ...
                            <div class="ec-product-body">
                                ...
                                <ul class="ec-rating">
                                    <li class="ecicon">
                                        @if(\App\Models\Comment::average($key->id))
                                            <div class="rateYo-{{$key->id}}"></div>
                                            <script>
                                                $(function () {
                                                    $("div.rateYo-{{$key->id}}").rateYo({
                                                        rating: {{ \App\Models\Comment::average($key->id)}},
                                                        spacing: "5px",
                                                        readOnly: true
                                                    });
                                                });
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 ec-link-icon">
                                        @auth
                                            <a data-tip="Add to Wishlist" data-target="wishlist" data-role="{{ $key->id }}">
                                                <i class="md md-favorite-outline"></i>
                                            </a>
                                        @else
                                            <a data-tip="Add to Wishlist" data-target="BtnWishlist">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 ec-link-btn">
                                        @auth
                                            <button type="button" name="AddToCart" value="{{ $key->id }}" class=" ec-add-to-cart">Sepete Ekle</button>
                                        @else
                                            <button type="button" name="BtnAddToCart" class=" ec-add-to-cart">Sepete Ekle</button>
                                        @endauth
                                    </div>

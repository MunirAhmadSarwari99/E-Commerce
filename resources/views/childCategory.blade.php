                    ...
                    <div class="row ec_breadcrumb_inner">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <ul class="ec-breadcrumb-list">
                                ...
                                <li class="ec-breadcrumb-item active">{{ $catgory->category->categoryName .' >> '. $catgory->childName }}</li>
                            </ul>
                            ...
                            <div class="ec-product-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 ec-link-btn">
                                        <button type="button" name="AddToCart" value="{{ $product->id }}" class=" ec-add-to-cart" href="#">Sepete Ekle</button>
                                    </div>
                                </div>
                            </div>
                        </div>
